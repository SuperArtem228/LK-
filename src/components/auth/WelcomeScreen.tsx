...
import { Zap, Search, Send, Calendar, ArrowRight } from 'lucide-react'
    ...
    <div className="w-full max-w-[480px] animate-fade-in">
      <div className="bg-white rounded-2xl shadow-sm border border-zinc-100 p-8 text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg text-sm font-medium bg-indigo-600 text-white hover:bg-indigo-700 active:bg-indigo-800 transition-all"
        >
          Настроить профиль
